...
ASM_PFX(AsmGetAddressMap):
    ...
    mov        qword [rcx + 18h], SwitchToRealProcEnd - SwitchToRealProcStart       ; SwitchToRealSize
    mov        qword [rcx + 1Ch], SwitchToRealProcStart - RendezvousFunnelProcStart ; SwitchToRealOffset
    mov        qword [rcx + 20h], SwitchToRealProcStart - Flat32Start               ; SwitchToRealNoNxOffset
    mov        qword [rcx + 24h], 0                                                 ; SwitchToRealPM16ModeOffset
    mov        qword [rcx + 28h], 0                                                 ; SwitchToRealPM16ModeSize
