/** @file
  ...
  Copyright (C) 2020-2021, Advanced Micro Devices, Inc. All rights reserved.<BR>
...
{
  MSR_SEV_ES_GHCB_REGISTER  Msr, CurrentMsr;
  ...
  //
  Msr.GhcbPhysicalAddress = 0;
  Msr.GhcbGpaRegister.Function = GHCB_INFO_GPA_REGISTER_REQUEST;
  ...
  //
  if ((Msr.GhcbGpaRegister.Function != GHCB_INFO_GPA_REGISTER_RESPONSE) ||
      (Msr.GhcbGpaRegister.GuestFrameNumber != GuestFrameNumber)) {
